...
* [Poster at ISCE'18](https://dl.acm.org/citation.cfm?id=3194972)
...
## Installation
1. Download the running package file ([ALPACARunningPackage](https://drive.google.com/open?id=15vsTIBb1M3IGIRMZe6aA9mZlGv_PyjVs))
2. Unzip the package.
